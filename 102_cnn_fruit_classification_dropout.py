...
model.add(Dropout(0.5))                                                        # 0.5: 50% of neurons will be dropped out (usually works well)
                                                                               # Droupout is added to dense layer only
    # output layer                                                                             
...
model_filename = 'models/fruits_cnn_v02.h5'                                    # to save our model named fruits_cnn_v01 in models forlder
